					...
					<jsp:body>
						<div class="well col-md-12" style="background-color: #d1c4e9 ">
							<form action="criterioChave">
								...
								<div div class=" well col-md-12 row"><span>Formacao</span></div>

								<div class=" well col-md-12 row" id="Graduacao" style="background-color: #ffab91">
									<div class="col-md-12 row">
										<div class="col-md-2">
											<label>Estado:</label>
											</br>
											<input type="checkbox" id="myCheckGraduacao" name="myCheckGraduacao" onclick="Graduacao(this)">
											<text id="txtGraduacao">Desativo</text>
										</div>
										<div class="col-md-6">
											<label>Criterio:</label>
											</br>
											<label>Possui Graduacao</label>
										</div>
									</div>
									<div class="col-md-12 row well hidden" id="GraduacaoMisto">
										<div class="col-md-12 row">
											<div class="col-md-2">
												<label>Tipo:</label>
											</div>
								...
								<div class=" well col-md-12 row" id="Especializacao" style="background-color: #ffab91">
									<div class="col-md-12 row">
										<div class="col-md-2">
											<label>Estado:</label>
											</br>
											<input type="checkbox" id="myCheckEspecializacao" name="myCheckEspecializacao" onclick="Especializacao(this)">
											<text id="txtEspecializacao">Desativo</text>
										</div>
										<div class="col-md-6">
											<label>Criterio:</label>
											</br>
											<label>Possui Especializacao</label>
										</div>
									</div>
									<div class="col-md-12 row well hidden" id="EspecializacaoMisto">
										<div class="col-md-12 row">
											<div class="col-md-2">
												<label>Tipo:</label>
											</div>
								...
								<div class=" well col-md-12 row" id="artCompPerioInd" style="background-color: #ffab91">
									<div class="col-md-2">
										...
										<input type="checkbox" id="myCheckartCompPerioInd" onclick="artCompPerioInd(this)">
										<text id="txtartCompPerioInd">Desativo</text>
									</div>
									<div class="col-md-6">
										<label>Criterio:</label>
										</br>
								...
								<div class=" well col-md-12 row" id="artCompAceitoPublic" style="background-color: #ffab91">
									<div class="col-md-2">
										...
										<input type="checkbox" id="myCheckartCompAceitoPublic" onclick="artCompAceitoPublic(this)">
										<text id="txtartCompAceitoPublic">Desativo</text>
									</div>
									<div class="col-md-6">
										<label>Criterio:</label>
										</br>
								...
								<div class=" well col-md-12 row" id="trabEvento" style="background-color: #ffab91">
									<div class="col-md-12 row">
										<div class="col-md-2">
											...
											<input type="checkbox" id="myChecktrabEvento" name="myChecktrabEvento" onclick="trabEvento(this)">
											<text id="txttrabEvento">Desativo</text>
										</div>
										<div class="col-md-6">
											<label>Criterio:</label>
											</br>
									...
									<div class="hidden" id="trabEventoCaixa">
										<div class="col-md-12 row well">
											<div class="col-md-12">
												<label>
													<input type="radio" name="TrabRadio" id="TrabRadio" value="1" onclick="trabEventoMisto(this)" disabled> Trabalho misto
												</label>
											</div>
										...
										<div class="col-md-12 row well">
											<div class="col-md-12">
												<label>
													<input type="radio" name="TrabRadio" id="TrabRadio1" onclick="trabEventoSeparado(this)" disabled> Trabalho separado
												</label>
											</div>
								...
								<div class=" well col-md-12 row" id="depPatente" style="background-color: #ffab91">
									...
									<div class="hidden" id="depPatenteCaixa">
										<div class="col-md-12 row well">
											<div class="col-md-12">
												<label>
													<input type="radio" name="PatRadio" id="PatRadio" value="1" onclick="PatenteMisto(this)" disabled> Patente misto
												</label>
											</div>
										...
										<div class="col-md-12 row well">
											<div class="col-md-12">
												<label>
													<input type="radio" name="PatRadio" id="PatRadio1" value="2" onclick="PatenteSeparado(this)" disabled> Patente separado
												</label>
											</div>
								...
								<div class=" well col-md-12 row" id="BancMest" style="background-color: #ffab91">
									...
									<div class="hidden" id="BancMestCaixa">
										<div class="col-md-12 row well">
											<div class="col-md-12">
												<label>
													<input type="radio" name="BancMestRadio" id="BancMestRadio" value="1" onclick="BancMestMisto(this)" disabled> Banca Mestrado
												</label>
											</div>
										...
										<div class="col-md-12 row well">
											<div class="col-md-12">
												<label>
													<input type="radio" name="BancMestRadio" id="BancMestRadio1" value="2" onclick="BancMestSeparado(this)" disabled> Banca Mestrado Separada
												</label>
											</div>
								...
								<div class=" well col-md-12 row" id="BancDout" style="background-color: #ffab91">
									...
									<div class="hidden" id="BancDoutCaixa">
										<div class="col-md-12 row well">
											<div class="col-md-12">
												<label>
													<input type="radio" name="BancDoutRadio" id="BancDoutRadio" value="1" onclick="BancDoutMisto(this)" disabled> Banca Doutorado misto
												</label>
											</div>
										...
										<div class="col-md-12 row well">
											<div class="col-md-12">
												<label>
													<input type="radio" name="BancDoutRadio" id="BancDoutRadio1" value="2" onclick="BancDoutSeparado(this)" disabled> Banca Doutorado separado
												</label>
											</div>
								...
								<div class=" well col-md-12 row" id="BancQualDout" style="background-color: #ffab91">
									...
									<div class="hidden" id="BancQualDoutCaixa">
										<div class="col-md-12 row well">
											<div class="col-md-12">
												<label>
													<input type="radio" name="BancQualDoutRadio" id="BancQualDoutRadio" value="1" onclick="BancQualDoutMisto(this)" disabled> Banca de Qualificação de Doutorado misto
												</label>
											</div>
										...
										<div class="col-md-12 row well">
											<div class="col-md-12">
												<label>
													<input type="radio" name="BancQualDoutRadio" id="BancQualDoutRadio1" value="2" onclick="BancQualDoutSeparado(this)" disabled> Banca de Qualificação de Doutorado separado
												</label>
											</div>
								...
								<div class=" well col-md-12 row" id="OriDout" style="background-color: #ffab91">
									...
									<div class="hidden" id="OriDoutCaixa">
										<div class="col-md-12 row well">
											<div class="col-md-12">
												<label>
													<input type="checkbox" name="OriDoutcheck" id="OriDoutcheck" value="1" onclick="OriDoutMisto(this)" disabled> Orientação em andamento
												</label>
											</div>
										...
										<div class="col-md-12 row well">
											<div class="col-md-12">
												<label>
													<input type="checkbox" name="OriDoutcheck" id="OriDoutcheck1" value="2" onclick="OriDoutSeparado(this)" disabled> Orientação concluida
												</label>
											</div>
								...
								<div class=" well col-md-12 row" id="OriMest" style="background-color: #ffab91">
									...
									<div class="hidden" id="OriMestCaixa">
										...
										<div class="col-md-12 row well">
											<div class="col-md-12">
												<label>
													<input type="checkbox" name="OriMestcheck" id="OriMestcheck" value="1" onclick="OriMestMisto(this)" disabled> Orientação em andamento
												</label>
											</div>
										...
										<div class="col-md-12 row well">
											<div class="col-md-12">
												<label>
													<input type="checkbox" name="OriMestcheck" id="OriMestcheck1" value="2" onclick="OriMestSeparado(this)" disabled> Orientação concluida
												</label>
											</div>
								...
								<div class=" well col-md-12 row" id="ProdArt" style="background-color: #ffab91">
									...
									<div class="hidden" id="ProdArtCaixa">
										...
										<div class="col-md-12 row well">
											<div class="col-md-12">
												<label>
													<input type="radio" name="ProdArtRadio" id="ProdArtRadio" value="1" onclick="ProdArtMisto(this)" disabled> Produção artistica misto
												</label>
											</div>
										...
										<div class="col-md-12 row well">
											<div class="col-md-12">
												<label>
													<input type="radio" name="ProdArtRadio" id="ProdArtRadio1" value="2" onclick="ProdArtSeparado(this)" disabled> Produção artistica separada
												</label>
											</div>
