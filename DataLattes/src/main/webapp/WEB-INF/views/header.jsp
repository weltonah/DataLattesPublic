...
<div class="container-fluid bg-primary" style="height: 100vh;padding-right:0px;">
...
<ul class="nav flex-column" >
  ...
  <a class="btn btn-outline-light " aria-pressed="true" href="index" role="button"
   ...
   <a class="btn btn-outline-light" data-toggle="tooltip" data-placement="right" title="Ajuda"
   href="index" role="button" style="font-size: 1.3vw;border:0px;border-radius:0px;">
   ...
   data-toggle="tooltip" data-placement="right" title="Github"
    href="index" role="button" style="font-size: 1.3vw;padding:0px;border:0px;">
   <i class="ion-social-github" style="font-size:4vh;"></i>
   
   </a>
    <a class="btn btn-outline-dark"
    data-toggle="tooltip" data-placement="right" title="Changelog"
     href="index" role="button" style="font-size: 1.3vw;padding-left:0px;padding-right:0px;border:0px;"> V: 1.0.0
   </a>
   </div></div>
   </div></div>
